...
void main(){
  ...
  void mockHttpData(Map json) async => mockRequest().thenAnswer((_) async => json);
  ...
  test('Should returns UnexpectedError if HttpClient returns 200 with invalid data', () async{
